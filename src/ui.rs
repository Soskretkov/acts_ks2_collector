...
fn show_details() {
    ...
    println!("            Наименование на GitHub.com:   «acts_ks2_etl»");
    println!("            Адрес прокта на GitHub.com:   https://github.com/Soskretkov/acts_ks2_etl");
    println!("            Дата создания:                14.06.2022");
    println!("            Дата последних изменений:     14.06.2022");
